 ...
 */
public abstract class LuceneEosLookup extends Configured {
    ...
    /**
     * Executes the query and returns a list of
     * {@linkplain LookupEntry#getRelevance() relevance} sorted entries.
     * <p>The query must be of type returned by {@link #newQuery()}.
     * @param query the query to execute
     * @return a list of sorrted 
     * @throws EosException if an error occurs
     * @see #newQuery()
     */
    public abstract List<LookupEntry> lookup(final EosQuery query) throws EosException;

    /**
     * Creates a new query instance to configure and than execute thru
     * {@link #lookup(EosQuery)}.
     * @return a new query instance
     * @see #lookup(EosQuery)
     * @throws EosException if an error occurs
     */
    public abstract EosQuery newQuery() throws EosException;
}
