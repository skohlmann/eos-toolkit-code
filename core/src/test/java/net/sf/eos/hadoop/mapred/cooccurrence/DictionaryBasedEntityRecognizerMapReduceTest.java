...
public class DictionaryBasedEntityRecognizerMapReduceTest
    ...
    public DictionaryBasedEntityRecognizerMapReduceTest() throws IOException {
        this(HadoopTestCase.LOCAL_MR, HadoopTestCase.LOCAL_FS, 2, 2);
    }

    public DictionaryBasedEntityRecognizerMapReduceTest(final int mrMode, 
                                                        final int fsMode,
    ...
    public void testSimpleMapReduce() throws Exception {
        ...
        jobConf.setJobName("eos entity test");
        ...
        jobConf.set(TokenizerSupplier.TOKENIZER_PROVIDER_IMPL_CONFIG_NAME,
    ...
    protected void setUp() throws Exception {
        super.setUp();
        this.resultPath =
            LOCAL_PATH + "/DictionaryBasedEntityRecognizerMapReduceTest.testresult";
    }
