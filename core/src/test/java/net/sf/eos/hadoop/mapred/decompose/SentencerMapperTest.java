...
public class SentencerMapperTest extends HadoopTestCase {

    private static final String INPUT_EOSDOCS =
        "SentencerMapperTest.eosdocs";
    ...
    public SentencerMapperTest() throws IOException {
        this(HadoopTestCase.LOCAL_MR, HadoopTestCase.LOCAL_FS, 2, 2);
    }

    public SentencerMapperTest(final int mrMode, 
                               final int fsMode,
                               final int taskTrackers,
                               final int dataNodes) throws IOException {
    ...
    protected void setUp() throws Exception {
        super.setUp();
        this.resultPath = LOCAL_PATH + "/SentencerMapperTest.testresult";
    }
    ...
    public void testSimpleJob() throws Exception {
        ...
        jobConf.setJobName("eos Sentencer Test");
