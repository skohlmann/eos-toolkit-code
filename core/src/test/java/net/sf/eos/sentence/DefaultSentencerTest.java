...
public class DefaultSentencerTest {
    ...
    public void toSentenceHashMap() throws Exception {
        ...
        doc1.setText("This maybe the same frist sentence. "
                     + "And the sencond same sentence.");
        ...
        doc2.setText("This maybe the same frist sentence. "
                     + "And the sencond same sentence.");
        ...
        final Map<String, EosDocument> sentenced1 =
            sentencer.toSentenceDocuments(doc1,
                                          sentenceTokenizer,
                                          tokenizer,
                                          TextBuilder.SPACE_BUILDER);
        final Map<String, EosDocument> sentenced2 =
            sentencer.toSentenceDocuments(doc2,
                                          sentenceTokenizer,
                                          tokenizer,
                                          TextBuilder.SPACE_BUILDER);
